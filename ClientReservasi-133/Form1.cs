...
namespace ClientReservasi_133
{
    public partial class Form1 : Form
    {
        ...
        private void btSimpan_Click(object sender, EventArgs e)
        {
            ...
            string No_Telfon = textBoxNoTlf.Text;
            int JumlahPemesanan = int.Parse(textBoxJumlah.Text);
            string IdLokasi = textBoxIDLokasi.Text;

            var a = service.pemesanan(IDPemesanan, NamaCustomer, No_Telfon, JumlahPemesanan, IdLokasi);
            MessageBox.Show(a);
            TampilData();
            Clear();
        }
        ...
        private void btUpdate_Click(object sender, EventArgs e)
        {
            ...
            var a = service.editPemesanan(IDPemesanan, NamaCustomer, No_Telfon);
            MessageBox.Show(a);
            TampilData();
            Clear();
        }
